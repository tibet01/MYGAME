...
{
	this->window = new sf::RenderWindow(sf::VideoMode(800, 600), "Pyhtagoras Shooter", sf::Style::Close | sf::Style::Titlebar);
...
void Game::initTextures()
{
	...
	this->textures["BULLET"]->loadFromFile("pic/bullet.png");
}
